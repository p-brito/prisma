...
{
    internal sealed class DynamoDbProvider<TEntity> : IPrismaProvider<TEntity>
        where TEntity : BaseEntity
    {
        ...
        public async Task<TEntity> UpdateAsync(TEntity entity, CancellationToken cancellationToken = default)
        {
            try
            {
                ...
                {
                    throw new PrismaException(PrismaError.ErrorUpdate, Properties.Resources.RES_Exception_Update_EntityDoesNotExist.Format(entity.Id));
                }
