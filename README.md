[![NetLicensing C# Client - CI](https://github.com/p-brito/MagicDb/workflows/build/badge.svg)](https://github.com/p-brito/MagicDb/actions?query=workflow%3A%22MagicDb+-+build%22)
